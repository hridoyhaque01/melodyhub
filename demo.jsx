...
function Topnav() {
  ...
  return (
    <header className="py-6 px-10 bg-dark-30">
      <nav className="flex items-center justify-between">
        ...
        <div className="relative lg:hidden block">
          <div className="flex items-center bg-dark-50 pr-2 rounded-sm">
            <input
              type="text"
              placeholder="search here..."
              className="w-80  bg-transparent outline-none p-3 text-sm text-fadeLight"
            />
        ...
        <div className=" flex items-center gap-6">
          <div className="relative">
            ...
            <div
              className={`absolute right-0 top-0 w-[20rem] max-w-xs bg-blackHigh p-4 rounded-lg ${
            ...
            <div
              className={`absolute right-12 top-0 w-[20rem] max-w-xs bg-blackHigh p-4 rounded-lg ${
          ...
          <ul className="flex items-center gap-6">
            {/* <li>
              <NavLink
                to=""
                className="flex items-center gap-1 py-3 px-6 border border-blue rounded-md"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 101 101"
            ...
            <li>
              <NavLink
                to=""
                className="flex items-center gap-1 py-3 px-6 bg-blue rounded-md"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 64 64"
